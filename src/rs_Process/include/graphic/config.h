...
//hsv掩码参数
#define LOWER_BLUE_MASK 150
#define UPPER_BLUE_MASK 200
#define LOWER_RED_MASK 0
#define UPPER_RED_MASK 3
...
//侧边识别参数
#define SIDE_TRIANGLE_GRAPH_AREA_MIN 120 //侧边三角形相机面积最小值
#define SIDE_TRIANGLE_REAL_AREA_MIN 10 //侧边三角形真实面积最小值
#define SIDE_TRIANGLE_REAL_LONG_DISTANCE_MIN 10//侧边三角形长边长度最小值
